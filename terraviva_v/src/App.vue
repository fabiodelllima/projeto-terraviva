    ...
    <nav class="navbar is-transparent">
      ...
      >
        ...
        <div class="navbar-end">
          <router-link to="/legumes" class="navbar-item" id="custom-hover">
            Legumes
          </router-link>
          <router-link to="/frutas" class="navbar-item" id="custom-hover">
            Frutas
          </router-link>
          <div class="navbar-item">
            <div class="buttons">
    ...
    <footer class="footer" id="custom-footer">
      <div class="custom-footer-wrapper">
        <div class="custom-footer-box a">
          <div>
            <p id="custom-logo-footer">
              terra<strong id="custom-strong-footer">viva</strong>
            </p>
          </div>
          <div>
            <p>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis
              scelerisque tempus eros, at auctor mauris porta id. Donec
              venenatis eros in sapien tempus, sed pulvinar sapien egestas.
